...
| 48 | K | **OceanData Context Provider SPI ADR** (Vorschlag, FA-2 aus ADR-0004): Trait-Form, Sensitivity-/Provenance-Schema, bounded results, Privacy-/Redaction-Hook. **Keine** Implementation, **kein** Provider-Kind, **kein** IPC. |
